...
const addOne = (arr) => {
    let arrN=[];
    arr.forEach((ele)=>arrN.push(ele+1));
    return arrN;
};
...
const addExclamation = (arr) => {
    let arrN=[];
    arr.forEach((ele)=>arrN.push(ele.concat('!')));
    return arrN;
};
...
const allUpperCase = (arr) => {
    let arrUp=[];
    arr.forEach((ele)=>arrUp.push(ele.toUpperCase()));
    return arrUp;
...
const speaker = (words, callback) => {
    ...
    let arr=[];
    words.forEach((ele)=>arr.push(callback(ele)));
    return arr;
};
...
const addNumbers =(value,arr,iter,addValues)=>{
...
const createList = (availableItems) => {
    ...
    let arr=[];
    availableItems.forEach((ele)=>ele.available===true?arr.push(ele.name):arr.continue)
    return arr;
};
...
const fizzbuzz = (arr) => {
    ...
    for(let i=0; i<arr.length;i++){
        ...
        else if(fizzArr[i]%5===0){
            fizzArr.push("Buzz");
        }
        else if(fizzArr[i]%3==0&&fizzArr[i]%5===0){
